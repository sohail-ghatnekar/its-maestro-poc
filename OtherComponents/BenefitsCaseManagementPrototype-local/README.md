...
5. Open MYB-1004 for the Michael Motorist SNAP/HEAP walkthrough.
...
20. Open Transaction Status and simulate acceptance.
21. Open Timeline / Audit and review the click-through history.
22. Open Operations Dashboard and show dashboard help.
23. Open Testing, open a command text box, run a mock SOAP, REST, or SFTP test, and review the populated mock return.
24. Open Help Center and search "reason code", "document", or "testing."
