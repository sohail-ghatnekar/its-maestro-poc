...
export const helpContent: Record<HelpContextId, HelpContent> = {
  ...
  operations: {
    ...
    summary: 'Use the dashboard to present fixed sample workload health, bottlenecks, due dates, and county/region metrics.',
    workerGuidance: [
  ...
  assignment: {
    ...
    summary: 'Use the assignment dashboard to choose the global task assignment strategy for the inbox.',
    workerGuidance: [
      'Choose one assignment criterion from the dropdown.',
      'Review the routing preview before applying.',
      'Apply criteria to update current inbox assignments locally.',
      'This dashboard is global and does not belong to a single case.',
    ],
    checklist: ['Select an assignment criterion.', 'Review the preview.', 'Apply criteria.', 'Return to Case Inbox if needed.'],
    keyTerms: [
      { term: 'Assignment Criteria', definition: 'The selected strategy used to route work in the prototype.' },
      { term: 'Routing Preview', definition: 'A sample of how loaded inbox cases will be assigned when the criteria is applied.' },
    ],
    relatedActions: ['Apply Criteria', 'Refresh Data Fabric', 'Open Case Inbox'],
    externalReferences: commonReferences,
  },
  testing: {
    screenId: 'testing',
...
export const demoCoachTips: Partial<Record<HelpContextId, string[]>> = {
  ...
  assignment: ['Open Assignment Dashboard to choose a global assignment strategy before routing cases.'],
