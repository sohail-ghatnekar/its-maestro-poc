...
export const ACTION_APP_DEFINITIONS: ActionAppDefinition[] = [
  ...
  },
  {
    ...
    keywords: ['review budget results', 'budget review', 'eligibility calculation', 'benefit amount'],
  },
  {
    id: 'main-worker-final-review',
    appId: '71d523fa-c838-40fe-9edf-7935b7e112f5',
    name: 'Worker Final Review',
    ...
    keywords: ['final', 'worker review', 'case review', 'determination'],
  },
  {
    ...
    keywords: ['supervisor review', 'approval', 'approve', 'simple approval'],
  },
];
